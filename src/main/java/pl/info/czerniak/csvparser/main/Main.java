...
import pl.info.czerniak.csvparser.dao.PostgresTestDAOImpl;
...
public class Main {
    ...
    public static void main(String[] args) throws NoSuchAttributeException, IncorrectColNumberFileException, IOException, SQLException {
        ...
        PostgresTestDAOImpl dao = new PostgresTestDAOImpl();
        dao.create(csvParser);
        /*
